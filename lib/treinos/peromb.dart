...
import 'package:papv2/exercdetalhes/pernsdetalhes.dart';
import 'package:papv2/treinos/workout_data.dart';

class Peromb extends StatelessWidget{
          ...
          children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/exercicios/tPeO.jpg'),
                      fit: BoxFit.cover,
            ...
            ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                DataExerc dataexerc = poround1[index];
                return Card(
                  child: ListTile(
                    isThreeLine: true,
                    leading: Container(
                    ...
                    onTap:(){
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder:(context) => PERNSDetalhes(dataexerc))
                      );
                    },
                  ),
                );
