...
import 'package:papv2/exercdetalhes/triceps.dart';
        ...
        child: Column(
          children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/exercicios/triceps.png'),
                      fit: BoxFit.cover,
            ...
            ListView.builder(
              ...
              itemCount: triceps1.length,
              itemBuilder: (BuildContext context, int index){
                DataExerc dataexerc = triceps1[index];
                return Card(
                  child: ListTile(
                    isThreeLine: true,
                    leading: Container(
                    ...
                    onTap:(){
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder:(context) => Tricepsd(dataexerc))
                      );
                    },
                  ),
                );
