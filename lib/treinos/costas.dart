...
import 'package:papv2/exercdetalhes/costas.dart';
import 'package:papv2/treinos/second_workout_data.dart';

class Costas extends StatelessWidget{
  @override
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                DataExerc dataexerc = costas1[index];
                return Card(
                  child: ListTile(
                    isThreeLine: true,
                    leading: Container(
                    ...
                    onTap:(){
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder:(context) => Costasd(dataexerc))
                      );
                    },
                  ),
                );
